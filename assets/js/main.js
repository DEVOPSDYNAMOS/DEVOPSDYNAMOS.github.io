...
const softwareDevelopersDropdown = document.getElementById('softwareDevelopersDropdown');
const ethicalHackersDropdown = document.getElementById('ethicalHackersDropdown');
const informationSecurityDropdown = document.getElementById('informationSecurityDropdown');

// Set path prefixes for each category
const softwareDevelopersPathPrefix = "software-developers/build/assets/Skills/softwaredev.html";
const ethicalHackersPathPrefix = "/ethical-hackers";
const informationSecurityPathPrefix = "/information-security";

softwareDevelopersDropdown.addEventListener('change', (event) => {
  const selectedOption = event.target.value;
  const url = `${softwareDevelopersPathPrefix}/${selectedOption}`;
  window.location.href = url;
});

ethicalHackersDropdown.addEventListener('change', (event) => {
  const selectedOption = event.target.value;
  const url = `${ethicalHackersPathPrefix}/${selectedOption}`;
  window.location.href = url;
});

informationSecurityDropdown.addEventListener('change', (event) => {
  const selectedOption = event.target.value;
  const url = `${informationSecurityPathPrefix}/${selectedOption}`;
  window.location.href = url;
});
...
function copyright() {
  ...
  copyFinal = "© "  + copyrightYear + " Made by Abdul mazood";
...
window.ityped.init(document.querySelector('.ityped'),{
  strings: ['Designer','Software Engineer','Devoloper'],
  loop: true,
  typeSpeed:  150,
  backDelay: 3000,
})
